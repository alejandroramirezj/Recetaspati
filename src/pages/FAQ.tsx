    ...
    <main className="flex-grow container mx-auto px-4 py-16">
      ...
      <Accordion type="single" collapsible className="w-full max-w-3xl mx-auto space-y-2">
        <AccordionItem value="item-1" className="border rounded-lg shadow-sm bg-white">
          <AccordionTrigger className="px-6 py-2 text-left text-xl font-semibold text-pati-burgundy hover:no-underline">¿Se puede congelar la tarta?</AccordionTrigger>
          <AccordionContent className="px-6 pb-2 text-pati-dark-brown text-lg leading-relaxed">
        ...
        <AccordionItem value="item-2" className="border rounded-lg shadow-sm bg-white">
          <AccordionTrigger className="px-6 py-2 text-left text-xl font-semibold text-pati-burgundy hover:no-underline">¿Cómo conservar los productos?</AccordionTrigger>
          <AccordionContent className="px-6 pb-2 text-pati-dark-brown text-lg leading-relaxed">
        ...
        <AccordionItem value="item-3" className="border rounded-lg shadow-sm bg-white">
          <AccordionTrigger className="px-6 py-2 text-left text-xl font-semibold text-pati-burgundy hover:no-underline">¿Cuánto dura el pedido tras hacerlo?</AccordionTrigger>
          <AccordionContent className="px-6 pb-2 text-pati-dark-brown text-lg leading-relaxed">
        ...
        <AccordionItem value="item-4" className="border rounded-lg shadow-sm bg-white">
          <AccordionTrigger className="px-6 py-2 text-left text-xl font-semibold text-pati-burgundy hover:no-underline">¿Puedo elegir relleno y topping?</AccordionTrigger>
          <AccordionContent className="px-6 pb-2 text-pati-dark-brown text-lg leading-relaxed">
        ...
        <AccordionItem value="item-5" className="border rounded-lg shadow-sm bg-white">
          <AccordionTrigger className="px-6 py-2 text-left text-xl font-semibold text-pati-burgundy hover:no-underline">¿Cómo recibiré mi pedido (caja, fechas de envío)?</AccordionTrigger>
          <AccordionContent className="px-6 pb-2 text-pati-dark-brown text-lg leading-relaxed">
