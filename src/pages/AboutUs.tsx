  ...
  return (
    <main className="flex-grow container mx-auto px-4 py-16">
      ...
      <section className="max-w-3xl mx-auto text-pati-dark-brown text-lg leading-relaxed text-center">
        <p>
          Soy Pati 👋, el alma de <strong>Recetas Pati</strong>. Mi pasión por la cocina <strong>desde pequeñita</strong> me llevó a especializarme en la <strong>repostería</strong> 🍪. Mi logo es un reflejo de mis pasiones: <strong>Deporte</strong> 💪, mi perrita <strong>Arya</strong> 🐶 y la <strong>repostería</strong> 👩‍🍳.
        </p>
      </section>
    </main>
  );
